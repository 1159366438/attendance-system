...
### 6.4 CHANGELOG更新规则
- 使用 git-cliff 自动生成 CHANGELOG，不再手动维护 `doc/CHANGELOG.md` 文件。
- 变更记录通过符合 conventional commits 规范的提交信息自动生成。
- git-cliff 配置文件位于项目根目录的 `.cliff.toml`。
...
- **CHANGELOG.md**：版本变更日志，由 git-cliff 工具根据提交信息自动生成，不再手动维护。
